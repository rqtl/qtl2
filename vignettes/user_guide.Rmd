...
the package and can be loaded into R using the `read_cross2()`
function.

In the [qtl2geno package source](https://github.com/rqtl/qtl2geno), the sample
zip files are
located in
...
within whatever directory your R packages were installed. The R
