...
For the spleen phenotype, Haley-Knott regression and the linear mixed
model with the LOCO method give very similar results, while the linear
mixed model with an overall kinship matrix gives much lower LOD
scores.

For the liver phenotype, the linear mixed model with an overall
kinship matrix again gives much lower LOD scores. However, with this
phenotype, Haley-Knott regression and LOCO give quite different
results, with LOCO giving higher LOD scores except on chromosome 16.
