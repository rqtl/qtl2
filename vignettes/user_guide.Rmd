...
**We are in the process of splitting the package into two parts,
  [qtl2geno](https://github.com/rqtl/qtl2geno) for genotype
  probability calculations, and
  [qtl2scan](https://github.com/rqtl/qtl2scan) for QTL scans.**
...
zip files are
located in
[`qtl2geno/inst/extdata`](https://github.com/rqtl/qtl2/tree/master/inst/extdata).
