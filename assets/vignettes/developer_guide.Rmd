...
- `"riself4"`, `"riself8"`, and `"riself16"` for 4-, 8-, and 16-way
  RIL by selfing
...
Another important idea is from [Pjotr Prins](https://thebird.nl/)'s
...
The control file can be in [YAML](https://yaml.org) or
[JSON](https://json.org) formats. Both are
...
For more detail, see
[the input file format vignette](https://kbroman.org/qtl2/assets/vignettes/input_files.html).
