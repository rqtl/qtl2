...
The perform SNP association analysis in the region of a QTL, we'll
need to grab data on all of the SNPs in the region, including their
genotypes in the eight founder strains for the CC and DO populations. We'll
also want to identify the genes in the region.
...
returned take just three arguments (`chr`, `start`, end `end`), and
return a data frame of variants on the one hand and genes on the
other.
...
flexibility on the part of the user. And for our own work, we see
great advantage in have a local SQLite database, for rapid queries of
SNPs and genes.
