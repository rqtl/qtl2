...
code can be rather slow.) On _Windows_, you'll need
[Rtools](https://cran.r-project.org/bin/windows/Rtools/). On _Mac OS
X_, you'll need the
...
included in the qtl2 package; there's also a `CCorigcolors` object
...
region, and `plot_genes()` to plot the gene
