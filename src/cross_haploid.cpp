...
bool HAPLOID::check_geno(int gen, bool is_observed_value,
...
double HAPLOID::init(int true_gen, bool ignored1, bool ignored2,
...
double HAPLOID::emit(int obs_gen, int true_gen, double error_prob,
                    bool ignored1, bool ignored2, IntegerVector ignored3)
{
...
double HAPLOID::step(int gen_left, int gen_right, double rec_frac,
                    bool ignored1, bool ignored2, IntegerVector ignored3)
{
...
int HAPLOID::ngen(bool ignored1)
{
    return 2;
}

double HAPLOID::nrec(int gen_left, int gen_right,
                    bool ignored1, bool ignored2, IntegerVector ignored3)
{
    check_geno(gen_left, false, ignored1, ignored2, ignored3);
    check_geno(gen_right, false, ignored1, ignored2, ignored3);
...
double HAPLOID::est_rec_frac(NumericMatrix gamma, bool is_X_chr)
{
