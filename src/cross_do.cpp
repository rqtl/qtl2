...
enum gen_do {A=1, H=2, B=3, notA=5, notB=4};
...
// not implemented
const NumericVector DO::est_map2(const IntegerMatrix& genotypes,
                                 ...
                                 const bool verbose)
{
    Rcpp::stop("est_map not yet implemented for Diversity Outbreds.");
