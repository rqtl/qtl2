...
test_that("calc_errorlod works for RIL", {
    ...
    expected_c19 <- structure(c(-9.32903349322453, -8.47969967361246, 2.32305847185214,
                                -5.8984498866156, -9.47387982744307, -8.33322897276546, -3.99257501280787,
                                -4.20445561350873, -7.5049377506975, -9.14740064817939, -9.09510142269189,
                                -6.77227860247852, -5.15283845448013, -6.99865296523756, -9.7673077116393,
                                -5.40229994233128), .Dim = c(4L, 4L),
                              .Dimnames = list(c("1", "4", "58", "59"),
                                               c("UNC190139327", "UNC190279660", "backupUNC190139992", "UNC190140427")))

    expect_equal(err[[1]][,7:10], expected_c19)

    expected_cX <- structure(c(-6.08215309397117, -14.8926244769183, -6.51837211358649,
                               -6.88113100332547, 0, -13.0390969498225, -0.442221668220816,
                               -1.145409261427, -15.3870175699701, -12.3080292675226, -13.4693995023715,
                               4.18951622414836, -15.6201478140083, -15.783391269451, -16.4361888981374,
                               -9.60278035406677, -17.5023617378269, -9.87297773997256, -16.8078077788826,
                               -7.20508163646767), .Dim = 4:5, .Dimnames = list(c("1", "4",
