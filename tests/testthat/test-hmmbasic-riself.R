...
test_that("riself check_geno works", {
    ...
    expect_false(test_check_geno("riself", 3, TRUE, FALSE, FALSE, numeric(0)))
    expect_false(test_check_geno("riself", 0, FALSE, FALSE, FALSE, numeric(0)))
    expect_false(test_check_geno("riself", 3, FALSE, FALSE, FALSE, numeric(0)))
...
test_that("riself emit works", {
    ...
    # errors
    expect_equal(test_emit("riself", 0, 0, eps, FALSE, FALSE, numeric(0)), 0)
    expect_equal(test_emit("riself", 0, 3, eps, FALSE, FALSE, numeric(0)), 0)
    expect_equal(test_emit("riself", 3, 1, eps, FALSE, FALSE, numeric(0)), 0)
