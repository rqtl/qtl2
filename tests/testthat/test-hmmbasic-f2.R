...
test_that("intercross emit works", {
    ...
    expect_equal(test_emit("f2", 1, 4, eps, TRUE, TRUE, 1), 0)
    expect_equal(test_emit("f2", 2, 4, eps, TRUE, TRUE, 1), log(eps))
    expect_equal(test_emit("f2", 3, 4, eps, TRUE, TRUE, 1), log(1-eps))
    expect_equal(test_emit("f2", 4, 4, eps, TRUE, TRUE, 1), log(eps))
    expect_equal(test_emit("f2", 5, 4, eps, TRUE, TRUE, 1), 0)
    expect_equal(test_emit("f2", 1, 3, eps, TRUE, TRUE, 1), 0)
    expect_equal(test_emit("f2", 2, 3, eps, TRUE, TRUE, 1), log(1-eps))
    expect_equal(test_emit("f2", 3, 3, eps, TRUE, TRUE, 1), log(eps))
    expect_equal(test_emit("f2", 4, 3, eps, TRUE, TRUE, 1), log(1-eps))
    expect_equal(test_emit("f2", 5, 3, eps, TRUE, TRUE, 1), 0)

    # X male
    for(i in 5:6)
        expect_equal(test_emit("f2", 0, i, eps, TRUE, FALSE, 0), 0)
    expect_equal(test_emit("f2", 1, 5, eps, TRUE, FALSE, 0), log(1-eps))
    expect_equal(test_emit("f2", 2, 5, eps, TRUE, FALSE, 0), 0)
    expect_equal(test_emit("f2", 3, 5, eps, TRUE, FALSE, 0), log(eps))
    expect_equal(test_emit("f2", 4, 5, eps, TRUE, FALSE, 0), log(1-eps))
    expect_equal(test_emit("f2", 5, 5, eps, TRUE, FALSE, 0), log(eps))
    expect_equal(test_emit("f2", 1, 6, eps, TRUE, FALSE, 0), log(eps))
    expect_equal(test_emit("f2", 2, 6, eps, TRUE, FALSE, 0), 0)
    expect_equal(test_emit("f2", 3, 6, eps, TRUE, FALSE, 0), log(1-eps))
    expect_equal(test_emit("f2", 4, 6, eps, TRUE, FALSE, 0), log(eps))
    expect_equal(test_emit("f2", 5, 6, eps, TRUE, FALSE, 0), log(1-eps))

    # X male reverse
    for(i in 5:6)
        expect_equal(test_emit("f2", 0, i, eps, TRUE, FALSE, 1), 0)
    expect_equal(test_emit("f2", 1, 5, eps, TRUE, FALSE, 1), log(1-eps))
    expect_equal(test_emit("f2", 2, 5, eps, TRUE, FALSE, 1), 0)
    expect_equal(test_emit("f2", 3, 5, eps, TRUE, FALSE, 1), log(eps))
    expect_equal(test_emit("f2", 4, 5, eps, TRUE, FALSE, 1), log(1-eps))
    expect_equal(test_emit("f2", 5, 5, eps, TRUE, FALSE, 1), log(eps))
    expect_equal(test_emit("f2", 1, 6, eps, TRUE, FALSE, 1), log(eps))
    expect_equal(test_emit("f2", 2, 6, eps, TRUE, FALSE, 1), 0)
    expect_equal(test_emit("f2", 3, 6, eps, TRUE, FALSE, 1), log(1-eps))
    expect_equal(test_emit("f2", 4, 6, eps, TRUE, FALSE, 1), log(eps))
    expect_equal(test_emit("f2", 5, 6, eps, TRUE, FALSE, 1), log(1-eps))
