...
test_that("risib check_geno works", {
    ...
    expect_error(test_check_geno("risib", 3, TRUE, FALSE, FALSE, 0))
    expect_error(test_check_geno("risib", 0, FALSE, FALSE, FALSE, 0))
    expect_error(test_check_geno("risib", 3, FALSE, FALSE, FALSE, 0))
    ...
    expect_error(test_check_geno("risib", 3, TRUE, TRUE, TRUE, 0))
    expect_error(test_check_geno("risib", 0, FALSE, TRUE, TRUE, 0))
    expect_error(test_check_geno("risib", 3, FALSE, TRUE, TRUE, 0))
    ...
    expect_error(test_check_geno("risib", 3, TRUE, TRUE, TRUE, 1))
    expect_error(test_check_geno("risib", 0, FALSE, TRUE, TRUE, 1))
    expect_error(test_check_geno("risib", 3, FALSE, TRUE, TRUE, 1))

})

test_that("risib n_geno works", {

    expect_equal(test_n_geno("risib", FALSE), 2)
    expect_equal(test_n_geno("risib", TRUE), 2)
...
test_that("risib geno_index works", {
    ...
    # autosome
    expect_equal(test_geno_index("risib", FALSE, FALSE, 0), 0:1)
    # X chr
    expect_equal(test_geno_index("risib", TRUE, TRUE, 0), 0:1)
    # X chr reverse
    expect_equal(test_geno_index("risib", TRUE, TRUE, 1), 0:1)
