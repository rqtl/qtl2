...
test_that("risib emit works", {
    ...
    # errors
    expect_equal(test_emit("risib", 0, 0, eps, FALSE, FALSE, 0), 0)
    expect_equal(test_emit("risib", 0, 3, eps, FALSE, FALSE, 0), 0)
    expect_equal(test_emit("risib", 3, 1, eps, FALSE, FALSE, 0), 0)
    # X chr
    expect_equal(test_emit("risib", 0, 0, eps, TRUE, TRUE, 0), 0)
    expect_equal(test_emit("risib", 0, 3, eps, TRUE, TRUE, 0), 0)
    expect_equal(test_emit("risib", 3, 1, eps, TRUE, TRUE, 0), 0)
    # X chr reverse
    expect_equal(test_emit("risib", 0, 0, eps, TRUE, FALSE, 1), 0)
    expect_equal(test_emit("risib", 0, 3, eps, TRUE, FALSE, 1), 0)
    expect_equal(test_emit("risib", 3, 1, eps, TRUE, FALSE, 1), 0)
